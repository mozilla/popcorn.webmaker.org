/*global $*/
define([ "dialog/dialog", "util/lang", "text!layouts/header.html",  "ui/widget/textbox", "ui/widget/tooltip", "make-api", "json!/api/butterconfig" ],
  function( Dialog, Lang, HEADER_TEMPLATE, TextBoxWrapper, ToolTip, Make, config ) {
