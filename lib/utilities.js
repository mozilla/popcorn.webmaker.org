...
module.exports.embedPath = function( user, id ) {
  return "/" + user + "/popcorn/" + this.slugify( id ) + "_";
};
...
module.exports.embedURL = function( user, id ) {
  ...
  return parsedURL.protocol + "//" + user + "." + parsedURL.hostname + "/popcorn/" + this.slugify( id ) + "_";
};

module.exports.embedShellPath = function( user, id ) {
  return "/" + user + "/popcorn/" + this.slugify( id );
};
...
module.exports.embedShellURL = function( user, id ) {
  ...
  return parsedURL.protocol + "//" + user + "." + parsedURL.hostname + "/popcorn/" + this.slugify( id );
};
