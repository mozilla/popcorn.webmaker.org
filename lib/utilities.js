...
module.exports.embedURL = function( user, id ) {
  ...
  return parsedURL.protocol + "//" + user + "." + parsedURL.hostname + "/popcorn/" + id + "_";
};
...
module.exports.embedShellURL = function( user, id ) {
  ...
  return parsedURL.protocol + "//" + user + "." + parsedURL.hostname + "/popcorn/" + id;
};
...
module.exports.pruneSearchResults = function( results ) {
  return results.map( function( result ) {
    return {
      ...
      publishUrl: this.embedShellURL( result.email, result.id ),
      iframeUrl: this.embedURL( result.email, result.id ),
