...
var options = require( "./config" ).metrics;
...
if( !options ) {
  ...
  // If a prefix is given, use it. Otherwise use `butter.'
  options.prefix = options.prefix || "butter." + config.NODE_ENV + ".";
  StatsD = require( 'node-statsd' ).StatsD;
}

module.exports = new StatsD( options.host, options.port, options.prefix,
